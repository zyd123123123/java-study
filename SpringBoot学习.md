...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2020072217243938.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDYzNTE5OA==,size_16,color_FFFFFF,t_70)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20200722172425309.png)
...
- 如果打包成功，则会在target目录下生成一个 jar 包
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20200722172409127.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDYzNTE5OA==,size_16,color_FFFFFF,t_70)
...
- 打成了jar包后，就可以在任何地方运行了！OK
  ...
  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20200722172348157.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDYzNTE5OA==,size_16,color_FFFFFF,t_70)

  浏览器运行结果（上图第⑤步）：

  ![在这里插入图片描述](https://img-blog.csdnimg.cn/20200722172331696.png)
...
2. 如何更改启动时显示的字符拼成的字母，SpringBoot呢？也就是 banner 图案；
 ...
 ![在这里插入图片描述](https://img-blog.csdnimg.cn/20200722172213335.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3dlaXhpbl80NDYzNTE5OA==,size_16,color_FFFFFF,t_70)
...
==总结：springboot所有配置都在spring.factories，要判断条件是否成立，只要导入对应的start就有对应的启动器==
...
进行按钮自动切换，需要配置localeresolver

将自己的组件写到spirng容器中@Bean
...
​		1.`th:fragment="siderbar"`

​		2.`<div th:replace="~{common/commons::siderbar(active='main.html')}"></div>`

​		3.如果要使用参数使用（）传参，接收判断即可

```html
提取公共页面
<nav class="col-md-2 d-none d-md-block bg-light sidebar" th:fragment="siderbar"></nav>

<div th:insert="~{dashboard::siderbar}"></div>
<!--侧边栏 传递参数给组件-->
<div th:replace="~{common/commons::siderbar(active='main.html')}"></div>
```
...
2、如何动态配置当项目处于test、dev环境时显示swagger，处于prod时不显示？生产环境中使用，在发布时不适用
...
@Service //将服务发布出去，选择dubbo的包不是spring的
@Component //放在容器中
public class TicketServiceImpl implements TicketService {
   @Override
   public String getTicket() {
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201103223432234.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNjQ5NTAz,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201103223750298.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNjQ5NTAz,size_16,color_FFFFFF,t_70#pic_center)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20201103224134417.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzQwNjQ5NTAz,size_16,color_FFFFFF,t_70#pic_center)
